var config = [ '$stateProvider', '$httpProvider', '$urlRouterProvider', '$authProvider', '$locationProvider', 'envServiceProvider', 'ezfbProvider',
	...
	envServiceProvider.config({
		domains: {
			development: ['localhost', 'kisikisi.dev', 'course.kisikisi.dev'],
			production: ['103.11.74.10', 'kisikisi.id', 'course.kisikisi.id']
		},
		vars: {
			development: {
				site: '//kisikisi.dev/',
				...
				course: '//course.kisikisi.dev/'

			},
			production: {
				site: '//kisikisi.id/',
				api: '//api.kisikisi.id/',
				course: '//course.kisikisi.id/',
