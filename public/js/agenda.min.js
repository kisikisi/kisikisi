var config=["$stateProvider","$httpProvider","$urlRouterProvider","$authProvider","$locationProvider","envServiceProvider","ezfbProvider",function(i,e,a,d,s,t,o){i.state("agenda",{url:"/",controller:"agendaIndexCtrl",templateUrl:"views/agenda/agenda.list.html"}).state("agenda.detail",{url:"{id:[a-zA-Z0-9.-]*}/{slug}",onEnter:["$stateParams","$rootScope",function(i,e){e.detailAgenda(i.id)}],onExit:["$stateParams","$rootScope",function(i,e){e.modal1.modal("hide")}]}),t.config({domains:{development:["localhost","kisikisi.dev","agenda.kisikisi.dev"],production:["103.11.74.10","kisikisi.id","agenda.kisikisi.id"]},vars:{development:{site:"//kisikisi.dev/",api:"//api.kisikisi.dev/",file:"//files.kisikisi.dev/",agenda:"//agenda.kisikisi.dev/"},production:{site:"//kisikisi.id/",api:"//api.kisikisi.id/",agenda:"//agenda.kisikisi.id/",file:"//files.kisikisi.id/"}}}),t.check(),s.html5Mode(!0),a.otherwise("/"),d.loginUrl="/login",d.signupUrl="/register",o.setInitParams({appId:"607018229476252"})}];
