...
var agendaCtrl=["$http","$scope","$rootScope","$state","$auth","$sce","$location","Notification","envService",function(e,a,n,t,o,r,d,l,s){n.env=s.read("all"),a.agendas=[],a.scrollBusy=!1,a.limit=12,a.after=0,a.onSearch=!1,a.filter={},a.url=d.absUrl(),null==o.getToken()&&o.setToken(),a.$on("$includeContentLoaded",function(e){a.modal1=$("#siteModal").modal(),a.modal2=$("#basicModal").modal()}),a.indexSearch=function(e,a){return e.map(function(e){return e.id}).indexOf(a)},a.toggleSearch=function(){0==a.onSearch?a.onSearch=!0:a.onSearch=!1},a.filterAgenda=function(){e.get(a.env.api+"agenda/form").success(function(e){a.agendaCategories=e.agendaCategories,a.cities=e.cities,a.provinces=e.provinces})},a.filterAgenda(),a.searchAgenda=function(e){a.after=0,a.agendas=[],a.nextPage(),a.filter=e,a.onSearch=!1,t.go("agenda")},a.agendaCalendar=function(){e.get(a.env.api+"agenda/calendar").success(function(e){var n=e.calendar;for(i=0;i<n.length;i++)n[i].start=moment.unix(e.calendar[i].start).format("YYYY-MM-DD"),n[i].end=moment.unix(e.calendar[i].end).format("YYYY-MM-DD");a.eventSources={events:n,color:"yellow",textColor:"black"}})},a.agendaCalendar(),a.nextPage=function(){a.scrollBusy=!0,e.get(a.env.api+"agenda/scroll/"+a.after+"/"+a.limit,{params:a.filter}).success(function(e){for(var n=0;n<e.agendas.length;n++)a.agendas.push(e.agendas[n]);e.agendas.length>0&&(a.after=e.agendas[e.agendas.length-1].id,a.scrollBusy=!1)})},a.loginForm=function(){a.modal2.modal("show")},a.detailAgenda=function(n){e.get(a.env.api+"agenda/"+n).success(function(e){a.detail=e.detail,a.detail.content=r.trustAsHtml(e.detail.content),a.detail.map_address=r.trustAsResourceUrl(e.detail.map_address),a.detail.start=moment.unix(e.detail.start_datetime).format("MM/DD/YYYY"),a.detail.end=moment.unix(e.detail.end_datetime).format("MM/DD/YYYY"),a.modal1.modal("show")})};var c=this;a.$watch(function(){return c.href},function(){c.rendered=!1})}];
