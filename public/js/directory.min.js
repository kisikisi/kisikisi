...
var dirIndexCtrl=["$http","$scope","$rootScope","$location","Notification","envService",function(o,s,c,l,t,e){s.schools=[],s.scrollBusy=!1,s.limit=12,s.after=0,s.nextPage=function(){s.scrollBusy=!0,o.get(s.env.api+"school/scroll/"+s.after+"/"+s.limit).success(function(o){for(var c=0;c<o.schools.length;c++)s.schools.push(o.schools[c]);s.after=o.schools[o.schools.length-1].id,s.scrollBusy=!1,$(".ui.sticky").sticky("refresh")})}}];
var dirCtrl=["$http","$scope","$rootScope","$location","Notification","envService",function(e,o,i,t,c,n){i.env=n.read("all"),o.modalTemplate="views/directory/school.detail.html",o.indexSearch=function(e,o){return e.map(function(e){return e.id}).indexOf(o)},o.filterSchool=function(){e.get(o.env.api+"school/form").success(function(e){o.schoolTypes=e.schoolTypes,o.cities=e.cities,o.provinces=e.provinces})},o.filterSchool(),o.detailSchool=function(i){o.modalTemplate="",e.get(o.env.api+"school/"+i).success(function(e){o.detail=e.detail[0],o.modalTemplate="views/directory/school.detail.html",$(".ui.modal").modal({observeChanges:!0}).modal("show")})};var l=this;o.$watch(function(){return l.href},function(){l.rendered=!1})}];
app=angular.module("kisiDirApp",["ui.router","ngSanitize","satellizer","ngTouch","superswipe","environment","ui-notification","ngTagsInput","ezfb","infinite-scroll"]),app.config(config).controller("dirCtrl",dirCtrl).controller("dirIndexCtrl",dirIndexCtrl).controller("dirDetailCtrl",dirDetailCtrl).directive("uiRating",function(){return function(i,n,t){$(n).rating()}}).directive("uiSticky",function(){return function(i,n,t){$(n).sticky({observeChanges:!0,context:"#content"})}}).directive("uiTab",function(){return function(i,n,t){$(n).tab()}});
