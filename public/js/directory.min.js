...
var dirCtrl=["$http","$scope","$rootScope","$location","Notification","envService",function(o,e,s,l,t,c){s.env=c.read("all"),$(".ui.sidebar").sidebar("toggle"),$(".ui.sidebar").sidebar("attach events","#mainNavToggle"),e.schools=[],e.scrollBusy=!1,e.limit=12,e.after=0,e.modalTemplate="views/directory/school.detail.html",e.indexSearch=function(o,e){return o.map(function(o){return o.id}).indexOf(e)},e.filterSchool=function(){o.get(e.env.api+"school/form").success(function(o){e.schoolTypes=o.schoolTypes,e.cities=o.cities,e.provinces=o.provinces})},e.filterSchool(),e.searchSchool=function(o){e.after=0,e.schools=[],e.nextPage()},e.nextPage=function(){e.scrollBusy=!0,console.log(e.filter),o.get(e.env.api+"school/scroll/"+e.after+"/"+e.limit,{params:e.filter}).success(function(o){for(var s=0;s<o.schools.length;s++)e.schools.push(o.schools[s]);o.schools.length>0&&(e.after=o.schools[o.schools.length-1].id),e.scrollBusy=!1})},e.detailSchool=function(s){e.modalTemplate="",o.get(e.env.api+"school/"+s).success(function(o){e.detail=o.detail[0],e.modalTemplate="views/directory/school.detail.html",$(".ui.modal").modal({observeChanges:!0}).modal("show")})};var i=this;e.$watch(function(){return i.href},function(){i.rendered=!1})}];
app=angular.module("kisiDirApp",["ui.router","ngSanitize","satellizer","ngTouch","superswipe","environment","ui-notification","ngTagsInput","ezfb","infinite-scroll"]),app.config(config).controller("dirCtrl",dirCtrl).controller("dirIndexCtrl",dirIndexCtrl).controller("dirDetailCtrl",dirDetailCtrl).directive("uiRating",function(){return function(i,n,r){$(n).rating()}}).directive("ukSticky",function(){return function(i,n,r){UIkit.sticky(n)}}).directive("uiTab",function(){return function(i,n,r){$(n).tab()}}).directive("uiDropdown",function(){return function(i,n,r){$(n).dropdown({keepOnScreen:!1})}});
