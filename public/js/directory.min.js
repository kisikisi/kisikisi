var config=["$stateProvider","$httpProvider","$urlRouterProvider","$authProvider","$locationProvider","envServiceProvider","ezfbProvider",function(i,e,r,o,s,t,d){i.state("school",{url:"/",controller:"dirIndexCtrl",templateUrl:"views/directory/school.list.html"}).state("schoolDetail",{url:"/{id:[a-zA-Z1-9.-]*}",controller:"dirDetailCtrl",templateUrl:"views/directory/school.detail.html"}),t.config({domains:{development:["localhost","kisikisi.dev","direktori.kisikisi.dev"],production:["103.11.74.10","kisikisi.id","direktori.kisikisi.id"]},vars:{development:{site:"//kisikisi.dev/",api:"//api.kisikisi.dev/",file:"//files.kisikisi.dev/",dir:"//direktori.kisikisi.dev/"},production:{site:"//kisikisi.id/",api:"//api.kisikisi.id/",dir:"//direktori.kisikisi.id/",file:"//files.kisikisi.id/"}}}),t.check(),s.html5Mode(!0),r.otherwise("/"),o.loginUrl="/login",d.setInitParams({appId:"135688693164869"})}];
