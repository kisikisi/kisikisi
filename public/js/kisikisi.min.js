...
angular.module("environment",[]).provider("envService",function(){this.environment="development",this.data={},this.config=function(t){this.data=t},this.set=function(t){this.environment=t},this.get=function(){return this.environment},this.read=function(t){return"all"!==t?this.data.vars[this.get()][t]:this.data.vars[this.get()]},this.is=function(t){return t===this.environment},this.check=function(){var t=window.location.href,n=this;angular.forEach(this.data.domains,function(i,e){angular.forEach(i,function(i){t.match("//"+i)&&(n.environment=e)})})},this.$get=function(){return this}});
