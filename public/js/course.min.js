var config=["$stateProvider","$httpProvider","$urlRouterProvider","$authProvider","$locationProvider","envServiceProvider","ezfbProvider",function(i,e,s,r,o,t,l){i.state("course",{url:"/",controller:"courseIndexCtrl",templateUrl:"views/course/course.list.html"}).state("courseDetail",{url:"/{id:[a-zA-Z1-9.-]*}",controller:"courseDetailCtrl",templateUrl:"views/course/course.detail.html"}),t.config({domains:{development:["localhost","kisikisi.dev","course.kisikisi.dev"],production:["103.11.74.10","kisikisi.id","course.kisikisi.id"]},vars:{development:{site:"//kisikisi.dev/",api:"//api.kisikisi.dev/",file:"//files.kisikisi.dev/",course:"//course.kisikisi.dev/"},production:{site:"//kisikisi.id/",api:"//api.kisikisi.id/",course:"//course.kisikisi.id/",file:"//files.kisikisi.id/"}}}),t.check(),o.html5Mode(!0),s.otherwise("/"),r.loginUrl="/login",l.setInitParams({appId:"135688693164869"})}];
