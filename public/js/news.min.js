var config=["$stateProvider","$httpProvider","$urlRouterProvider","$authProvider","$locationProvider","envServiceProvider","ezfbProvider",function(i,e,s,t,r,o,d){i.state("news",{url:"/",controller:"newsIndexCtrl",templateUrl:"views/news/news.list.html"}).state("news.detail",{url:"{id:[a-zA-Z0-9.-]*}/{slug}",onEnter:["$stateParams","$rootScope",function(i,e){e.detailNews(i.id)}],onExit:["$stateParams","$rootScope",function(i,e){e.modal1.modal("hide")}]}),o.config({domains:{development:["localhost","kisikisi.dev","berita.kisikisi.dev"],production:["103.11.74.10","kisikisi.id","berita.kisikisi.id"]},vars:{development:{site:"//kisikisi.dev/",api:"//api.kisikisi.dev/",file:"//files.kisikisi.dev/",news:"//berita.kisikisi.dev/"},production:{site:"//kisikisi.id/",api:"//api.kisikisi.id/",news:"//berita.kisikisi.id/",file:"//files.kisikisi.id/"}}}),o.check(),r.html5Mode(!0),s.otherwise("/"),t.loginUrl="/login",t.signupUrl="/register",d.setInitParams({appId:"135688693164869"})}];
