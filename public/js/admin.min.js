...
var newsCatCtrl=["$http","$scope","Notification",function(e,t,s){$.AdminLTE.layout.fix(),t.currentPage=1,t.limit=10,t.listCategory=function(){e.get(t.env.api+"news/category").success(function(e){t.categories=e.categories})},t.addCategory=function(a){e.post(t.env.api+"news/category",a).success(function(e){s({message:e.message},e.status),"success"==e.status&&(t.categories.push(e.category),t.input={},$("#name").focus())})},t.saveCategory=function(s,a){return e.put(t.env.api+"news/category/"+a,s)},t.deleteCategory=function(a){var c=t.indexSearch(t.type,a);confirm("delete news category?")&&e["delete"](t.env.api+"news/category/"+a).success(function(e){s({message:e.message},e.status),"success"==e.status&&t.categories.splice(c,1)})},t.listCategory()}];
var newsCtrl=["$http","$scope","$location","Upload","Notification",function(e,s,n,t,a){$.AdminLTE.layout.fix(),s.onEdit=!1,s.input={},s.schoolAddForm={},s.currentPage=1,s.limit=10,s.listNews=function(){e.get(s.env.api+"news").success(function(e){s.news=e.news})},s.formNews=function(){e.get(s.env.api+"news/form").success(function(e){s.labels=e.labels,s.newsCategories=e.newsCategories})},s.slug=function(e){return e=e.replace(/[^a-zA-Z0-9\s]/g,""),e=e.toLowerCase(),e=e.replace(/\s/g,"-")},s.loadLabels=function(e){return s.labels},s.addLabel=function(n,t){e.post(s.env.api+"news/"+t+"/label/"+n.id).success(function(e){return"success"==e.status})},s.removeLabel=function(n,t){return confirm("remove label?")?void e["delete"](s.env.api+"news/"+t+"/label/"+n.id).success(function(e){return"success"==e.status?!0:void 0}):!1},s.uploadCover=function(e,n){e&&(s.onProgress1=!0,t.upload({url:s.env.api+"news/cover",method:"POST",data:{image:n}}).then(function(e){s.onProgress1=!1,s.input.image_cover=e.data.cover},function(e){a({message:e.message},e.status)},function(e){var n=parseInt(100*e.loaded/e.total);s.progress1=n}))},s.uploadContent=function(e,n){e&&(s.onProgress2=!0,t.upload({url:s.env.api+"news/content",method:"POST",data:{image:n}}).then(function(e){s.onProgress2=!1,s.input.image_content=e.data.content},function(e){a({message:e.message},e.status)},function(e){var n=parseInt(100*e.loaded/e.total);s.progress2=n}))},s.saveNews=function(n){if(n.content=$("#addContent").val(),void 0==n.id)e.post(s.env.api+"news",n).success(function(e){a({message:e.message},e.status),"success"==e.status&&(s.news.push(e.news),s.input.id=e.news.id)});else{n.news_category_id=s.input.school_type.id;var t=s.indexSearch(s.news,n.id);e.put(s.env.api+"news/"+n.id,n).then(function(e){s.news[t]=e.data.news[0],a({message:e.data.message},e.status)})}},s.editNews=function(t){e.get(s.env.api+"news/"+t).success(function(e){s.input=e.detail,s.input.news_label=e.newsLabel,s.input.news_category_id=parseInt(s.input.news_category_id),s.input.status=parseInt(s.input.status),$("#addContent").val(s.input.content),$("[data-widget='collapse']").click(),n.hash("newsForm")})},s.deleteNews=function(n){var t=s.indexSearch(s.type,n);confirm("delete type?")&&e["delete"](s.env.api+"news/"+n).success(function(e){a({message:e.message},e.status),"success"==e.status&&s.type.splice(t,1)})},s.listNews(),s.formNews()}];
var schoolCtrl=["$http","$scope","$location","Notification","Upload",function(o,s,t,e,i){$.AdminLTE.layout.fix(),s.onEdit=!1,s.input={},s.schoolAddForm={},s.currentPage=1,s.limit=10,s.listSchool=function(){o.get(s.env.api+"school").success(function(o){s.school=o.school})},s.formSchool=function(){o.get(s.env.api+"school/form").success(function(o){s.schoolTypes=o.schoolTypes,s.cities=o.cities,s.provinces=o.provinces})},s.uploadLogo=function(o,t){o&&(s.onProgress1=!0,i.upload({url:s.env.api+"school/logo",method:"POST",data:{image:t}}).then(function(o){s.onProgress1=!1,s.input.logo=o.data.logo},function(o){e({message:o.message},o.status)},function(o){var t=parseInt(100*o.loaded/o.total);s.progress1=t}))},s.uploadImage=function(o,t){o&&(s.onProgress2=!0,i.upload({url:s.env.api+"school/image",method:"POST",data:{image:t}}).then(function(o){s.onProgress2=!1,s.input.image=o.data.image},function(o){e({message:o.message},o.status)},function(o){var t=parseInt(100*o.loaded/o.total);s.progress2=t}))},s.saveSchool=function(t){if(t.description=$("#addDescription").val(),t.data=$("#addData").val(),void 0!=t.id){t.city_id=s.input.city.id,t.school_type_id=s.input.school_type.id;var i=s.indexSearch(s.school,t.id);return o.put(s.env.api+"school/"+t.id,t).then(function(o){s.school[i]=o.data.school[0],e({message:o.data.message},o.status)})}o.post(s.env.api+"school",t).success(function(o){"success"==o.status&&(s.school.push(o.school[0]),s.input.id=o.school[0].id,e({message:o.message},o.status))})},s.editSchool=function(e){s.onEdit=!1,o.get(s.env.api+"school/"+e).success(function(o){s.edit=o.detail[0],$("#editDescription").val(s.edit.description),$("#editData").val(s.edit.description),$(".formcontrol.textarea").wysihtml5(),$("[data-widget='collapse']").click(),s.onEdit=!0,t.hash("schoolForm")})},s.deleteSchool=function(t){var i=s.indexSearch(s.school,t);confirm("delete school?")&&o["delete"](s.env.api+"school/"+t).success(function(o){e({message:o.message},o.status),"success"==o.status&&s.school.splice(i,1)})},s.listSchool(),s.formSchool()}];
var schoolTypeCtrl=["$http","$scope","Notification",function(e,t,s){$.AdminLTE.layout.fix(),t.currentPage=1,t.limit=10,t.listType=function(){e.get(t.env.api+"school/type").success(function(e){t.type=e.type})},t.addType=function(c){e.post(t.env.api+"school/type",c).success(function(e){s({message:e.message},e.status),"success"==e.status&&(t.type.push(e.type),t.input={},$("#code").focus())})},t.saveType=function(s,c){return e.put(t.env.api+"school/type/"+c,s)},t.deleteType=function(c){var p=t.indexSearch(t.type,c);confirm("delete type?")&&e["delete"](t.env.api+"school/type/"+c).success(function(e){s({message:e.message},e.status),"success"==e.status&&t.type.splice(p,1)})},t.listType()}];
app=angular.module("kisiApp",["ui.router","satellizer","ngTouch","superswipe","angularUtils.directives.dirPagination","xeditable","environment","ui-notification","ngFileUpload","ngTagsInput","toggle-switch"]),app.run(["editableOptions","editableThemes",function(t,l){l.bs3.inputClass="ui input",l.bs3.buttonsClass="ui button",t.theme="bs3"}]).config(config).controller("kisiCtrl",kisiCtrl).controller("homeCtrl",homeCtrl).controller("authCtrl",authCtrl).controller("labelCtrl",labelCtrl).controller("schoolTypeCtrl",schoolTypeCtrl).controller("schoolCtrl",schoolCtrl).controller("newsCtrl",newsCtrl).controller("newsCatCtrl",newsCatCtrl).controller("agendaCtrl",agendaCtrl).controller("agendaCatCtrl",agendaCatCtrl).directive("sidebar",function(){return function(t,l,r){$.AdminLTE.tree(l)}}).directive("wysihtml5",function(){return function(t,l,r){$(l).wysihtml5()}}).directive("datepicker",function(){return function(t,l,r){$(l).datepicker()}});
