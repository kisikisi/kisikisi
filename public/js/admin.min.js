...
var config=["$stateProvider","$httpProvider","$urlRouterProvider","$authProvider","$locationProvider","envServiceProvider",function(e,i,l,t,r,o){var a=["$q","$location","$auth",function(e,i,l){var t=e.defer();return l.isAuthenticated()?t.resolve():i.path("/login"),t.promise}],s=["$q","$auth",function(e,i){var l=e.defer();return i.isAuthenticated()?l.reject():l.resolve(),l.promise}];e.state("dashboard",{url:"/",templateUrl:"views/admin/dashboard.html",controller:"homeCtrl",resolve:{loginRequired:a}}).state("school",{url:"/school",templateUrl:"views/admin/school.html",controller:"schoolCtrl",resolve:{loginRequired:a}}).state("school-type",{url:"/school/type",templateUrl:"views/admin/school.type.html",controller:"schoolTypeCtrl",resolve:{loginRequired:a}}).state("login",{url:"/login",templateUrl:"views/admin/login.html",controller:"authCtrl",resolve:{skipIfLoggedIn:s}}).state("label",{url:"/label",templateUrl:"views/admin/label.html",controller:"labelCtrl",resolve:{loginRequired:a}}).state("news",{url:"/news",templateUrl:"views/admin/news.html",controller:"newsCtrl",resolve:{loginRequired:a}}).state("news-category",{url:"/news/category",templateUrl:"views/admin/news.category.html",controller:"newsCatCtrl",resolve:{loginRequired:a}}).state("agenda",{url:"/agenda",templateUrl:"views/admin/agenda.html",controller:"agendaCtrl",resolve:{loginRequired:a}}).state("agenda-category",{url:"/agenda/category",templateUrl:"views/admin/agenda.category.html",controller:"agendaCatCtrl",resolve:{loginRequired:a}}),o.config({domains:{development:["localhost","kisikisi.dev","admin.kisikisi.dev"],production:["103.11.74.10","kisikisi.id","admin.kisikisi.id"]},vars:{development:{site:"//kisikisi.dev/",api:"//api.kisikisi.dev/",admin:"//admin.kisikisi.dev/",file:"//files.kisikisi.dev/"},production:{site:"//kisikisi.id/",api:"//api.kisikisi.id/",admin:"//admin.kisikisi.id/",file:"//files.kisikisi.id/"}}}),o.check(),r.html5Mode(!0),l.otherwise("/"),t.loginUrl="/login"}];
