...
var config=["$stateProvider","$httpProvider","$urlRouterProvider","$authProvider","$locationProvider","envServiceProvider",function(e,i,l,r,t,s){var o=["$q","$location","$auth",function(e,i,l){var r=e.defer();return l.isAuthenticated()?r.resolve():i.path("/login"),r.promise}],a=["$q","$auth",function(e,i){var l=e.defer();return i.isAuthenticated()?l.reject():l.resolve(),l.promise}];e.state("dashboard",{url:"/",templateUrl:"views/admin/dashboard.html",controller:"homeCtrl",resolve:{loginRequired:o}}).state("school",{url:"/school",templateUrl:"views/admin/school.html",controller:"schoolCtrl",resolve:{loginRequired:o}}).state("school-type",{url:"/school/type",templateUrl:"views/admin/school.type.html",controller:"schoolTypeCtrl",resolve:{loginRequired:o}}).state("login",{url:"/login",templateUrl:"views/admin/login.html",controller:"authCtrl",resolve:{skipIfLoggedIn:a}}).state("label",{url:"/label",templateUrl:"views/admin/label.html",controller:"labelCtrl",resolve:{loginRequired:o}}).state("news",{url:"/news",templateUrl:"views/admin/news.html",controller:"newsCtrl",resolve:{loginRequired:o}}).state("news-category",{url:"/news/category",templateUrl:"views/admin/news.category.html",controller:"newsCatCtrl",resolve:{loginRequired:o}}).state("agenda",{url:"/agenda",templateUrl:"views/admin/agenda.html",controller:"agendaCtrl",resolve:{loginRequired:o}}).state("agenda-category",{url:"/agenda/category",templateUrl:"views/admin/agenda.category.html",controller:"agendaCatCtrl",resolve:{loginRequired:o}}).state("scholarship",{url:"/scholarship",templateUrl:"views/admin/scholarship.html",controller:"scholarshipCtrl",resolve:{loginRequired:o}}).state("course",{url:"/course",templateUrl:"views/admin/course.html",controller:"courseCtrl",resolve:{loginRequired:o}}).state("user",{url:"/user",templateUrl:"views/admin/user.html",controller:"userCtrl",resolve:{loginRequired:o}}),s.config({domains:{development:["localhost","kisikisi.dev","setup.kisikisi.dev","files.kisikisi.dev"],production:["103.11.74.10","kisikisi.id","setup.kisikisi.id","files.kisikisi.id"]},vars:{development:{site:"//kisikisi.dev/",api:"//api.kisikisi.dev/",admin:"//setup.kisikisi.dev/",file:"//files.kisikisi.dev/"},production:{site:"//kisikisi.id/",api:"//api.kisikisi.id/",admin:"//setup.kisikisi.id/",file:"//files.kisikisi.id/"}}}),s.check(),t.html5Mode(!0),l.otherwise("/"),r.loginUrl="/login/setup"}];
