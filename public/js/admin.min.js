...
var schoolCtrl=["$http","$scope","$location","Notification","Upload",function(o,s,t,e,c){$.AdminLTE.layout.fix(),s.onEdit=!1,s.input={},s.schoolAddForm={},s.currentPage=1,s.limit=10,s.listSchool=function(){o.get(s.env.api+"school").success(function(o){s.school=o.school})},s.formSchool=function(){o.get(s.env.api+"school/form").success(function(o){s.schoolTypes=o.schoolTypes,s.cities=o.cities,s.provinces=o.provinces})},s.uploadLogo=function(o,t){o&&(s.onProgress1=!0,c.upload({url:s.env.api+"school/logo",method:"POST",data:{image:t}}).then(function(o){s.onProgress1=!1,s.input.logo=o.data.logo},function(o){e({message:o.message},o.status)},function(o){var t=parseInt(100*o.loaded/o.total);s.progress1=t}))},s.uploadImage=function(o,t){o&&(s.onProgress2=!0,c.upload({url:s.env.api+"school/image",method:"POST",data:{image:t}}).then(function(o){s.onProgress2=!1,s.input.image=o.data.image},function(o){e({message:o.message},o.status)},function(o){var t=parseInt(100*o.loaded/o.total);s.progress2=t}))},s.addSchool=function(t){t.description=$("#addDescription").val(),t.data=$("#addData").val(),o.post(s.env.api+"school",t).success(function(o){"success"==o.status&&(s.school.push(o.school[0]),e({message:o.message},o.status),s.input={},s.fileicon={},$("#name").focus())})},s.editSchool=function(e){s.onEdit=!1,o.get(s.env.api+"school/"+e).success(function(o){s.edit=o.detail[0],s.onEdit=!0,t.hash("schoolEditForm")})},s.saveSchool=function(t,c){t.description=$("#editDescription").val(),t.data=$("#editData").val(),t.city_id=s.edit.city.id,t.school_type_id=s.edit.school_type.id;var i=s.indexSearch(s.school,c);return o.put(s.env.api+"school/"+c,t).then(function(o){s.school[i]=o.data.school[0],e({message:o.data.message},o.status),s.onEdit=!1})},s.deleteSchool=function(t){var c=s.indexSearch(s.school,t);confirm("delete school?")&&o["delete"](s.env.api+"school/"+t).success(function(o){e({message:o.message},o.status),"success"==o.status&&s.school.splice(c,1)})},s.listSchool(),s.formSchool()}];
