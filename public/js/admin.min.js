...
app=angular.module("kisiApp",["ui.router","satellizer","ngTouch","superswipe","angularUtils.directives.dirPagination","xeditable","environment","ui-notification","ngFileUpload","ngTagsInput","toggle-switch"]),app.run(["editableOptions","editableThemes",function(t,e){e.bs3.inputClass="ui input",e.bs3.buttonsClass="ui button",t.theme="bs3"}]).config(config).controller("kisiCtrl",kisiCtrl).controller("homeCtrl",homeCtrl).controller("authCtrl",authCtrl).controller("schoolTypeCtrl",schoolTypeCtrl).controller("schoolCtrl",schoolCtrl).controller("newsCtrl",newsCtrl).controller("newsCatCtrl",newsCatCtrl).controller("newsLabelCtrl",newsLabelCtrl).directive("sidebar",function(){return function(t,e,r){$.AdminLTE.tree(e)}}).directive("wysihtml5",function(){return function(t,e,r){$(e).wysihtml5()}}).directive("datepicker",function(){return function(t,e,r){$(e).datepicker()}});
