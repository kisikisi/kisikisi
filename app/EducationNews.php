...
class EducationNews extends Model
{
    ...
    public function newsList() {
        return $this->select(DB::raw("education_news.id, education_news.slug, education_news.title, education_news.content, c.name as category, education_news.date, u.name AS author, education_news.status, education_news.image_cover"))
